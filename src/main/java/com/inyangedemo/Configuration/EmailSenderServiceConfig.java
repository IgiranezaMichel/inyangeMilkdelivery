...
//     { 
//         this.sendEmail("ndagijimanapeter777@gmail.com","Login Successfully","<!doctype html><html lang=\"en\"><head><title>Sign up</title><body><h1 style='background-color:grey'>Inyange</h1><div style='background-color:white,border:1px solid black,border-radius:15'><h4>Welcome Page</h4><p>Dear , your account has been created successfully</p>"+
